# linux terminal autostart password script useless if ur in tty but very useful if ur using terminal emulator like if you're in a desktop enviroment why am i codeing this in a libary i mbored
